...
export default function Footer() {
  return (
    <footer id="contact" className="bg-navy-900 border-t border-white/5">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/50 text-xs">Bangladesh</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {exploreLinks.map((link) => (
                <li key={link.label}>
                  {link.isRoute ? (
                    <Link to={link.href} className="text-white/40 hover:text-gold-400 text-sm transition-colors duration-300">
                      {link.label}
                    </Link>
                  ) : (
                    <a href={link.href} className="text-white/40 hover:text-gold-400 text-sm transition-colors duration-300">
                      {link.label}
                    </a>
                  )}
                </li>
