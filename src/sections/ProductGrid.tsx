...
function ProductCard({
  ...
  return (
    ...
    >
      <div
        className="preserve-3d relative bg-navy-900/40 rounded-xl overflow-hidden border border-white/5 transition-all duration-300 hover:border-gold-500/30 hover:shadow-gold group cursor-pointer"
