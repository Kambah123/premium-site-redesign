        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span className="text-white font-semibold text-lg tracking-wide leading-tight">
                BIOGENIX
              </span>
            ...
            {navLinks.map((link) =>
              link.isRoute ? (
                <Link
                  key={link.label}
                  to={link.href}
                  className="text-white/70 hover:text-gold-400 text-sm font-medium transition-colors duration-300 relative group"
                >
                  {link.label}
          ...
          <div className="flex items-center gap-4">
            <button className="hidden md:flex text-white/70 hover:text-gold-400 transition-colors p-2">
              <Search size={20} />
            </button>
            <button className="hidden md:flex text-white/70 hover:text-gold-400 transition-colors p-2 relative">
              <ShoppingCart size={20} />
              <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-gold-500 text-navy-900 text-[10px] font-bold rounded-full flex items-center justify-center">
                0
              </span>
            </button>
