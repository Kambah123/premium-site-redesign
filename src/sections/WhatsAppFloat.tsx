export default function WhatsAppFloat() {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-16 bg-navy-900 text-white text-xs font-medium px-3 py-1.5 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none border border-white/10">
        Chat on WhatsApp
      </span>
    </a>
  );
